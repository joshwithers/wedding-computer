  ...
  async queue(batch: MessageBatch, env: Env['Bindings']): Promise<void> {
    for (const msg of batch.messages) {
      try {
        ...
        } else if (body.type === 'notify_wedding_date_changed') {
          await notifyWeddingDateChanged(notifyEnv(env), JSON.parse(body.payload))
          console.log('[QUEUE] notify_wedding_date_changed processed')
