...
export const timeline = {
  ...
  // Live weather forecast (Open-Meteo), shown within a week of the wedding.
  'weather.heading': 'Weather forecast',
  'weather.loading': 'Checking the forecast…',
  'weather.unavailable': 'Forecast not available yet.',
  'weather.weddingDay': 'Wedding day',
  'weather.onTheDay': 'On the day',
  'weather.source': 'Weather data by',
  'weather.unit.label': 'Temperature unit',
  'weather.unit.celsius': 'Show temperatures in Celsius',
  'weather.unit.fahrenheit': 'Show temperatures in Fahrenheit',
  ...
  'weather.cond.thunderstorm': 'Thunderstorms',
